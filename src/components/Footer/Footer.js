    ...
    <div className="Footer">
      <div className="FooterBody">
        <div className="FooterContainer">
          <div className="map" /> {/* Map in the left column */}
          <div>
            ...
            <div className="MediaLinks">
              ...
              <a
                href="https://www.linkedin.com/company/dsc-bvp/"
                target="_blank"
              >
                <box-icon
                  name="linkedin"
